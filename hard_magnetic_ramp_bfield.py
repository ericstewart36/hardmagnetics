...
b_app_max = Constant(16.25) #Constant(0.0094*Gshear0*mu0/b_rem_mag) 
...
T1 = TensorElement("Lagrange", mesh.ufl_cell(), 1, shape=(3,3)) # tensor internal variable 
...
# 
# Internal tensor variable for A1.
#
A1 = Function(W3)
#
...
# Discretized evolution equation for updating A1.
...
step2_time   = 2.5     # Total ramp time
step2_dt     = 0.003
Nstep2       = step2_time/step2_dt
#

#b_app_mag = Expression(("magnitude*t"),
b_app_mag = Expression(("magnitude*t/Tramp"),
...
# Output file setup
file_results = XDMFFile("results/hard_magnetic_ramp_bfield_R.xdmf")
...
expData = np.genfromtxt('exp_data/Tan_bRamp_coarse_data.csv', delimiter=',')
...
plt.tight_layout()
plt.savefig("plots/hard_magnetic_ramp_bfield.png", dpi=600)
